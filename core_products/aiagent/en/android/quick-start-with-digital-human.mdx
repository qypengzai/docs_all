...
<Warning title="Note">
- **digital_human_id**: The digital human ID, please contact ZEGO technical support to obtain it. Test with public ID: 63c3aa64-1d80-4b04-a0be-1c65614eb7eb.
      ...
      if (updateType === "ADD" && streamList.length > 0) {
        try {
          for (const stream of streamList) {
            ...
            if (remoteView) {
             // Here you need to have a container with an id of remoteSteamView to receive the AI agent stream
