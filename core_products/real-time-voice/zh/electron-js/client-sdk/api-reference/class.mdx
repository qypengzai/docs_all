...
<ParamField
  name="setPlayVolume"
  prototype="  setPlayVolume(audioEffectID: number, volume: number): void"
  desc="设置单个音效的本地播放音量。"
  parent_file="Declared in \`ZegoExpressAudioEffectPlayer.js\`"
  parent_name="ZegoAudioEffectPlayer"
  parent_type="class">
...
<ParamField
  ...
  prototype="  setPublishVolume(audioEffectID: number, volume: number): void"
  desc="设置单个音效的推流音量。"
  parent_file="Declared in \`ZegoExpressAudioEffectPlayer.js\`"
  parent_name="ZegoAudioEffectPlayer"
  parent_type="class">
...
<ParamField
  ...
  prototype="  setPlayVolumeAll(volume: number): void"
  desc="设置所有音效的本地播放音量。"
  parent_file="Declared in \`ZegoExpressAudioEffectPlayer.js\`"
  parent_name="ZegoAudioEffectPlayer"
  parent_type="class">
...
<ParamField
  ...
  prototype="  setPublishVolumeAll(volume: number): void"
  desc="设置所有音效的推流音量。"
  parent_file="Declared in \`ZegoExpressAudioEffectPlayer.js\`"
  parent_name="ZegoAudioEffectPlayer"
  parent_type="class">
...
<ParamField
  name="cancelDownload"
  prototype="  cancelDownload(resourceID: string): void"
  desc="取消下载音乐资源。"
  parent_file="Declared in \`ZegoExpressCopyrightedMusic.js\`"
  parent_name="ZegoCopyrightedMusic"
  parent_type="class">
...
<ParamField
  ...
  prototype="  setPlayStreamsAlignmentProperty(mode: [ZegoStreamAlignmentMode](./enum#zegostreamalignmentmode)): void"
  desc="设置拉流对齐属性。"
  parent_file="Declared in \`ZegoExpressEngine.js\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
<ParamField
  name="startMixerTask"
  prototype="  startMixerTask(task: [ZegoMixerTask](./struct#zegomixertask)): Promise&lt;Object&gt;"
  desc="开始混流任务。"
  parent_file="Declared in \`ZegoExpressEngine.js\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
开始混流任务结果。包含 errorCode 和 extendedData
</ParamField>
<ParamField
  name="stopMixerTask"
  prototype="  stopMixerTask(task: [ZegoMixerTask](./struct#zegomixertask)): Promise&lt;Object&gt;"
  desc="停止混流任务。"
  parent_file="Declared in \`ZegoExpressEngine.js\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
停止混流任务结果。包含 errorCode
</ParamField>
<ParamField
  name="startAutoMixerTask"
  prototype="  startAutoMixerTask(task: [ZegoAutoMixerTask](./struct#zegoautomixertask)): Promise&lt;Object&gt;"
  desc="开始自动混流任务"
  parent_file="Declared in \`ZegoExpressEngine.js\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
开始自动混流任务结果。包含 errorCode 和 extendedData
</ParamField>
<ParamField
  name="stopAutoMixerTask"
  prototype="  stopAutoMixerTask(task: [ZegoAutoMixerTask](./struct#zegoautomixertask)): Promise&lt;Object&gt;"
  desc="停止自动混流任务"
  parent_file="Declared in \`ZegoExpressEngine.js\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| millisecond | number | 音频频谱的监控时间周期，单位为毫秒，最小值为 10。默认 100 ms。 |
...
<ParamField
  ...
  prototype="  enableSpeechEnhance(enable: boolean, level: number): void"
  desc="开启或关闭人声增强。"
  parent_file="Declared in \`ZegoExpressEngine.js\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="  startAudioDataObserver(observerBitMask: number, param: [ZegoAudioFrameParam](./struct#zegoaudioframeparam)): void"
  desc="开启音频数据回调监测。"
  parent_file="Declared in \`ZegoExpressEngine.js\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| observerBitMask | number | 回调使能掩码标记位，参考 [ZegoAudioDataCallbackBitMask] 枚举；当转换为二进制时，0b01 即 1 &lt;&lt; 0 表示触发 [onCapturedAudioData], 0b10 即 1 &lt;&lt; 1 表示触发 [onPlaybackAudioData], 0b100 即 1 &lt;&lt; 2 表示触发 [onMixedAudioData], 0b1000 即 1 &lt;&lt; 3 表示触发 [onPlayerAudioData]。掩码可组合以使不同的回调同时触发。 |
...
<ParamField
  ...
  prototype="  stopAudioDataObserver(): void"
  desc="停止音频数据回调监测。"
  parent_file="Declared in \`ZegoExpressEngine.js\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="  onCapturedAudioData(data: Uint8Array, dataLength: number, param: [ZegoAudioFrameParam](./struct#zegoaudioframeparam)): void"
...
<ParamField
  ...
  prototype="  onPlaybackAudioData(data: Uint8Array, dataLength: number, param: [ZegoAudioFrameParam](./struct#zegoaudioframeparam)): void"
...
<ParamField
  ...
  prototype="  onMixedAudioData(data: Uint8Array, dataLength: number, param: [ZegoAudioFrameParam](./struct#zegoaudioframeparam)): void"
...
<ParamField
  ...
  prototype="  onPlayerAudioData(data: Uint8Array, dataLength: number, param: [ZegoAudioFrameParam](./struct#zegoaudioframeparam), streamID: string): void"
...
<ParamField
  ...
  prototype="  setAudioTrackMode(mode: [ZegoMediaPlayerAudioTrackMode](./enum#zegomediaplayeraudiotrackmode)): void"
  desc="设置播放器的音轨模式"
  parent_file="Declared in \`ZegoExpressMediaPlayer.js\`"
  parent_name="ZegoMediaPlayer"
  parent_type="class">
...
<ParamField
  ...
  prototype="  setAudioTrackPublishIndex(index: number): void"
  desc="设置媒体文件需要推流的音轨"
  parent_file="Declared in \`ZegoExpressMediaPlayer.js\`"
  parent_name="ZegoMediaPlayer"
  parent_type="class">
