...
export const extendedDataUpdatedCallback={
    ...
    "iOS,Windows": <a href="@-ZIMUserExtendedDataUpdatedCallback" target="_blank">ZIMUserExtendedDataUpdatedCallback</a>,
...
export const ZIMUserNameUpdatedCallback={
    ...
    "iOS,Windows": <a href="@-ZIMUserNameUpdatedCallback" target="_blank">ZIMUserNameUpdatedCallback</a>,
...
export const ZIMUserAvatarUrlUpdatedCallback={
    ...
    "iOS,Windows": <a href="@-ZIMUserAvatarUrlUpdatedCallback" target="_blank">ZIMUserAvatarUrlUpdatedCallback</a>,
...
export const ZIMUsersInfoQueriedCallback={
    ...
    "iOS,Windows": <a href="@-ZIMUsersInfoQueriedCallback" target="_blank">ZIMUsersInfoQueriedCallback</a>,
