...
export const onMessageReceivedMap = {
  ...
  'iOS': <a href='@ZIMMessageReceived' target='_blank'>messageReceived</a>,
  'mac': <a href='@ZIMMessageReceived' target='_blank'>messageReceived</a>,
}
...
export const ZIMMessageSentFullCallbackMap = {
  ...
  'Web,Flutter': <a href='@-ZIMMessageSentFullResult' target='_blank'>ZIMMessageSentFullResult</a>,
...
- [onMessageAttached](@onMessageAttached-ZIMMessageSentCallback): This callback is triggered before sending the reply, allowing you to obtain a temporary ZIMMessage object. You can use this object to add some logic, such as displaying UI in advance.
