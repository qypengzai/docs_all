...
<Card title="Sample Code" href="https://artifact-demo.zego.im/core_products/zim/zh/docs_zim_android_zh/ZIMExampleJava.zip" target="_blank">Click here to get the complete sample code.</Card>
