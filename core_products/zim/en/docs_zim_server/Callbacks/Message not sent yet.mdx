...
<tr>
<td><p id="msg_body">msg_body</p></td>
<td>String</td>
...
| new_payload | String | Modified message extension field, optional. Used to replace the [payload](#payload) in the callback parameters. |
| new_msg_body | String | Modified message content, optional. Used to replace the [msg_body](#msg_body) in the callback parameters. |

The message sender's client can obtain the reason why the message was rejected through the callback interface of the ZIM SDK. For detailed steps, please refer to [Send and receive messages - Monitor message status](/zim-android/guides/messaging/send-and-receive-messages#monitor-message-status).
...
| iOS | Android | macOS |
|-----|---------|-------|
| [messageSentStatusChanged](/zim-ios/client-sdks/api-reference/protocol#zimmessagesentstatuschanged)    | [onMessageSentStatusChanged](/zim-android/client-sdks/api-reference/class#onmessagesentstatuschanged)|[messageSentStatusChanged](/zim-macos/client-sdks/api-reference/protocol#zimmessagesentstatuschanged)|

| Windows | Web | React Native | 
|---------|-----|-----------|
| [onMessageSentStatusChanged](/zim-win/client-sdks/api-reference/class#onmessagesentstatuschanged)| [messageSentStatusChanged](/zim-web/client-sdks/api-reference/class#onmessagesentstatuschanged)|[messageSentStatusChanged](/zim-rn/client-sdks/api-reference/class#onmessagesentstatuschanged)|

| Flutter | Unity3D | 
|---------|---------|
| [onMessageSentStatusChanged](/zim-flutter/client-sdks/api-reference/class#onmessagesentstatuschanged)|[OnMessageSentStatusChanged](/zim-u3d/client-sdks/api-reference/class#onmessagesentstatuschanged)|
