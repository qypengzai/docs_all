...
The `zim:receivePeerMessage:fromUserID:`, `zim:receiveRoomMessage:fromRoomID:`, and `zim:receiveGroupMessage:fromGroupID:` callbacks deprecated in 2.18.0 have been officially removed in this version. It is recommended to migrate to [zim:messageReceivedWithResult:](@ZIMmessageReceivedWithResult:).
