...
export const onUserRuleUpdatedMap = {
  ...
  'iOS': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-user-rule-updated' target='_blank'>onUserRuleUpdated</a>,
  'mac': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-user-rule-updated' target='_blank'>onUserRuleUpdated</a>,
