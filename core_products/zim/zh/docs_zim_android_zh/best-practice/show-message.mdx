...
export const messageReceivedMap= {
  ...
  'iOS': <a href='/zim-ios/client-sdks/api-reference/protocol#zimmessagereceived' target='_blank'>onMessageReceived</a>,
  'mac': <a href='/zim-macos/client-sdks/api-reference/protocol#zimmessagereceived' target='_blank'>onMessageReceived</a>,
}
...
export const messageSentStatusChangedMap= {
  ...
  'iOS': <a href='/zim-ios/client-sdks/api-reference/protocol#zimmessagesentstatuschanged' target='_blank'>onMessageSentStatusChanged</a>,
  'mac': <a href='/zim-macos/client-sdks/api-reference/protocol#zimmessagesentstatuschanged' target='_blank'>onMessageSentStatusChanged</a>,
