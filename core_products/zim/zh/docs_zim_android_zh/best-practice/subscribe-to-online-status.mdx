...
export const onUserStatusUpdatedMap = {
  ...
  'iOS': <a href='/zim-ios/client-sdks/api-reference/protocol#zimuserstatusupdated' target='_blank'>onUserStatusUpdated</a>,
  'mac': <a href='/zim-macos/client-sdks/api-reference/protocol#zimuserstatusupdated' target='_blank'>onUserStatusUpdated</a>,
