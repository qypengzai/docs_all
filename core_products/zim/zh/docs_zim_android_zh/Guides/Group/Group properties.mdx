...
export const onGroupAttributesUpdatedMap = {
  ...
  'Web': <a href='@onGroupAttributesUpdated' target='_blank'>onGroupAttributesUpdated</a>,
  'UTS': <a href='@onGroupAttributesUpdated' target='_blank'>onGroupAttributesUpdated</a>,
  ...
  'iOS': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-group-attributes-updated-operated-info-group-id' target='_blank'>onGroupAttributesUpdated</a>,
  'mac': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-group-attributes-updated-operated-info-group-id' target='_blank'>onGroupAttributesUpdated</a>,
}
