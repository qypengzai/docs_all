...
export const onUserInfoUpdatedMap = {
  ...
  'iOS': <a href='@ZIMUserInfoUpdated' target='_blank'>userInfoUpdated</a>,
  'mac': <a href='@ZIMUserInfoUpdated' target='_blank'>userInfoUpdated</a>,
...
export const onCallUserStateChangedMap = {
  ...
  'iOS': <a href='@ZIMCallUserStateChanged' target='_blank'>callUserStateChanged</a>,
  'mac': <a href='@ZIMCallUserStateChanged' target='_blank'>callUserStateChanged</a>,
}
