...
export const onFriendListChangedMap = {
  ...
  'iOS': <a href='@ZIMFriendListChanged' target='_blank'>friendListChanged</a>,
  'mac': <a href='@ZIMFriendListChanged' target='_blank'>friendListChanged</a>,
...
export const onFriendApplicationListChangedMap = {
  ...
  'iOS': <a href='@ZIMFriendApplicationListChanged' target='_blank'>friendApplicationListChanged</a>,
  'mac': <a href='@ZIMFriendApplicationListChanged' target='_blank'>friendApplicationListChanged</a>,
...
export const onFriendApplicationUpdatedMap = {
  ...
  'iOS': <a href='@ZIMFriendApplicationUpdated' target='_blank'>friendApplicationUpdated</a>,
  'mac': <a href='@ZIMFriendApplicationUpdated' target='_blank'>friendApplicationUpdated</a>,
...
export const onFriendInfoUpdatedMap = {
  ...
  'iOS': <a href='@ZIMFriendInfoUpdated' target='_blank'>friendInfoUpdated</a>,
  'mac': <a href='@ZIMFriendInfoUpdated' target='_blank'>friendInfoUpdated</a>,
