...
export const onUserStatusUpdatedMap = {
  ...
  'iOS': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-user-status-updated' target='_blank'>onUserStatusUpdated</a>,
  'mac': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-user-status-updated' target='_blank'>onUserStatusUpdated</a>,
  "RN,uniapp,harmonyos": <a href="@onUserStatusUpdated">onUserStatusUpdated</a>,
  "UTS": <a href="@onUserStatusUpdated">onUserStatusUpdated</a>,
...
export const onConnectionStateChangedMap = {
  ...
  "RN,uniapp,harmonyos": <a href='@onConnectionStateChanged' target='_blank'>onConnectionStateChanged</a>,
