...
export const onConversationChangedMap = {
  ...
  'Web,harmonyos': <a href='@onConversationChanged' target='_blank'>onConversationChanged</a>,
...
export const onConversationSyncStateChangedMap = {
  ...
  'iOS,mac': <a href='@ZIMConversationSyncStateChanged' target='_blank'>conversationSyncStateChanged</a>,
}
