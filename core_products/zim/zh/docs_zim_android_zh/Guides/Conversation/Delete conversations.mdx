...
export const ZIMConversationsAllDeletedCallbackMap = {
  ...
  'Web,Flutter,UTS': <a href='@-ZIMConversationsAllDeletedResult' target='_blank'>ZIMConversationsAllDeletedResult</a>,
...
export const onConversationChangedMap = {
  ...
  'iOS': <a href='@zimconversationchanged' target='_blank'>onConversationChanged</a>,
  'mac': <a href='@zimconversationchanged' target='_blank'>onConversationChanged</a>,
