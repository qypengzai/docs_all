...
export const onMessageRevokeReceivedMap = {
  ...
  'Web': <a href='@onMessageRevokeReceived' target='_blank'>onMessageRevokeReceived</a>,
  'UTS': <a href='@onMessageRevokeReceived' target='_blank'>onMessageRevokeReceived</a>,
  'iOS': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-message-revoke-received' target='_blank'>onMessageRevokeReceived</a>,
  'mac': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-message-revoke-received' target='_blank'>onMessageRevokeReceived</a>,
