...
注册完成后，点击 “Service accounts > Generate new private key” 生成 JSON 配置文件。
<Frame width="512" height="auto" caption="">
  <img src="https://doc-media.zego.im/sdk-doc/Pics/ZIM/Web/download_google_json.png" />
</Frame>

**集成 SDK 时，需要在 [ZEGO 控制台](https://console.zego.im) 中上传 JSON 配置文件。**

<Frame width="512" height="auto" >
  <img src="https://doc-media.zego.im/core_products/zim/zh/docs_zim_web_zh/Offline push notifications/web_offline_push.png" />
</Frame>
