...
export const onPeerMessageReceivedMap = {
  'Android': <a href='@messageReceived' target='_blank'>messageReceived</a>,
  }
...
export const ZIMMessageReceiptsReadSentCallbackMap = {
  'Android':  <a href='@-ZIMMessageReceiptsReadSentResult' target='_blank'>ZIMMessageReceiptsReadSentResult</a>,
  }
...
export const ZIMConversationMessageReceiptReadSentCallbackMap = {
  'Android': <a href='@-ZIMConversationMessageReceiptReadSentResult' target='_blank'>ZIMConversationMessageReceiptReadSentResult</a>,
  }
export const onConversationMessageReceiptChangedMap = {
  'Android': <a href='@conversationMessageReceiptChanged' target='_blank'>conversationMessageReceiptChanged</a>,
  }
...
export const ZIMMessageReceiptsInfoQueriedCallbackMap = {
  'Android': <a href='@-ZIMMessageReceiptsInfoQueriedResult' target='_blank'>ZIMMessageReceiptsInfoQueriedResult</a>,
  }
