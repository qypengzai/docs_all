...
| <p id="payload">payload</p> | String | 消息扩展字段。 |
...
| new_payload | String | 修改后的消息扩展字段，可选。用于替换回调参数中的 [payload](#payload)。 |
| new_msg_body| String | 修改后的消息内容，可选。用于替换回调参数中的 [msg_body](#msg_body)。 |
...
| Windows | Web | 小程序 |
|---------|-----|--------|
| [onMessageSentStatusChanged](/zim-win/client-sdks/api-reference/class#onmessagesentstatuschanged)| [messageSentStatusChanged](/zim-web/client-sdks/api-reference/class#onmessagesentstatuschanged)| [messageSentStatusChanged](/zim-miniprogram/client-sdks/api-reference/class#onmessagesentstatuschanged)|

| Flutter | Unity3D | uni-app x|
|---------|---------|---------|
| [onMessageSentStatusChanged](/zim-flutter/client-sdks/api-reference/class#onmessagesentstatuschanged)|[OnMessageSentStatusChanged](/zim-u3d/client-sdks/api-reference/class#onmessagesentstatuschanged)|[messageSentStatusChanged](/zim-uniapp-x/client-sdks/api-reference/interface#messagesentstatuschanged)|

| React Native | HarmonyOS |  
|-----------|---|
|[messageSentStatusChanged](/zim-rn/client-sdks/api-reference/class#onmessagesentstatuschanged)|[messageSentStatusChanged](/zim-harmonyos/client-sdks/api-reference/interface#messagesentstatuschanged)| 
