...
<td>Based on the onNetworkQuality callback logic from version 2.14.0 to 2.21.1, two network quality status callbacks are supported: if a remote publishing user's heartbeat is lost once, their network quality callback will be "unknown"; if the heartbeat is lost 3 times, their network quality callback will be "die".</td>
</tr>
<tr>
