...
<td>Based on the onNetworkQuality interface callback logic of version 2.14.0 ~ 2.21.1, two network quality status callbacks are supported: if the remote publishing user's heartbeat is lost once, the callback network quality is unknown; if the remote publishing user's heartbeat is lost 3 times, the callback network quality is die.</td>
</tr>
<tr>
<td>2.14.0 ~ 2.21.1</td>
<td>
