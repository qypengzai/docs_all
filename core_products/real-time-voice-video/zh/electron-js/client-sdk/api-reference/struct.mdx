...
<ParamField
  ...
  prototype=" streamAlignmentVolumeControlMode: [ZegoStreamAlignmentVolumeControlMode](./enum#zegostreamalignmentvolumecontrolmode) "
  parent_name="ZegoAutoMixerTask"
  parent_type="class">
混流对齐场景音量调整模式。
</ParamField>
<ParamField
  ...
  prototype=" streamAlignmentBaselineStreamID: string "
  parent_name="ZegoAutoMixerTask"
  parent_type="class">
混流对齐场景的基准流 ID。
</ParamField>
...
<ParamField
  ...
  prototype=" codecNegotiationType: [ZegoCapabilityNegotiationType](./enum#zegocapabilitynegotiationtype) "
  parent_name="ZegoPublisherConfig"
  parent_type="class">
