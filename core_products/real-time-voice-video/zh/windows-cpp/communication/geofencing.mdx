...
- 已在项目中集成 ZEGO Express SDK，并实现了基本的音视频推拉流功能，详情请参考 [快速开始 - 集成](../quick-start/integrating-sdk.mdx) 和 [快速开始 - 实现流程](/real-time-video-windows-cpp/quick-start/implementing-video-call)。
