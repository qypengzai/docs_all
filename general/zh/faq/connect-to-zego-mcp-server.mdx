...
## 配置 ZEGO 文档 MCP 服务器 <a id="configure-zego-mcp-server" />
...
- [Claude Code](https://code.claude.com/docs/en/mcp#option-1:-add-a-remote-http-server)（建议直接使用我们提供的 Claude Code 插件自动配置 MCP 服务，详见下方 [Claude Code 配置使用](#claude-code-configuration) 章节。）
...
- [DeepSeek Harness](https://www.deepseek.com/harness/)（建议通过我们提供的 dsh 插件自动配置 MCP 服务，详见下方 [DeepSeek Harness 配置使用](#deepseek-harness-configuration) 章节。）

## Skill 及规则文件 <a id="skills-and-rules-file" />
...
## Claude Code 配置使用 <a id="claude-code-configuration" />
...
## DeepSeek Harness 配置使用 <a id="deepseek-harness-configuration" />
