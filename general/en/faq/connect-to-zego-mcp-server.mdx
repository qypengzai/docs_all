...
## Configure Skills and Rules File

For optimal results with the ZEGOCLOUD MCP service, it is recommended to:
- Set up the corresponding Skills in your AI programming tool and specify the use of these Skills when assigning development tasks to AI.
- Set up the corresponding rules file in your AI programming tool and specify the use of this rules file when assigning development tasks to AI.

<Tabs>
<Tab title="Using Skills">
Skills are intelligently triggered by AI programming tools and loaded on demand. We provide Skills for integrating ZEGOCLOUD products/fixing ZEGOCLOUD-related issues. Most AI programming tools are compatible with the [Claude Code skills](https://code.claude.com/docs/en/skills) protocol.

- If you are using Claude Code, follow our plugin installation guide to install [ZEGO Claude Code Plugins](https://github.com/ZEGOCLOUD/zego-claude-code-plugins).

<Video src="https://doc-media.zego.im/general/zh/faq/zego-claude-code-plugin.mp4" />

- If you are using DeepSeek Harness, install our [dsh-zego-assistant](https://github.com/ZEGOCLOUD/dsh-zego-assistant) plugin. The plugin automatically configures the ZEGOCLOUD Document MCP service and installs ZEGO-related Skills. After installation, restart the corresponding profile, and you can see that both zego-assistant and mcp-client are "Enabled" in "Settings > Plugins > Plugin list":
...
- If you are using other AI programming tools, download [ZEGO Claude Code Plugins](https://github.com/ZEGOCLOUD/zego-claude-code-plugins) locally and configure it by referring to the corresponding documentation.
</Tab>
<Tab title="Using Rules File">
Please copy and paste the following rules file content into your IDE's rules file.
...
- Claude Code: It is recommended to use the Skills configuration method.
